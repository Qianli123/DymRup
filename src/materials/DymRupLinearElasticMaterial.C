...
template<>
InputParameters validParams<DymRupLinearElasticMaterial>()
{
...
DymRupLinearElasticMaterial::DymRupLinearElasticMaterial(const InputParameters & parameters) :
...
void
DymRupLinearElasticMaterial::computeQpStrain()
{
...
void
DymRupLinearElasticMaterial::computeQpStress()
{
...
RankTwoTensor
DymRupLinearElasticMaterial::computeStressFreeStrain()
{
